...
\restrict hvvGnhlvkyIBD3DvJBFuRIrNdrWKDWG5jYTFtThaQMFKEfd0Pyu08emHASybqax
...
\unrestrict hvvGnhlvkyIBD3DvJBFuRIrNdrWKDWG5jYTFtThaQMFKEfd0Pyu08emHASybqax
\connect myapp
\restrict hvvGnhlvkyIBD3DvJBFuRIrNdrWKDWG5jYTFtThaQMFKEfd0Pyu08emHASybqax
...
99192a88-b053-46c1-b304-026088046819	Welcome	This is your first retro note. Try searching, tagging, and editing!	2026-03-02 04:32:48.740369+00	2026-03-02 04:32:48.740369+00
\.
...
b25d3ef8-e752-48cc-acd7-0102b4bb0ad2	work
\.
...
--
-- Name: idx_notes_search; Type: INDEX; Schema: public; Owner: appuser
--

CREATE INDEX idx_notes_search ON public.notes USING gin (to_tsvector('english'::regconfig, ((COALESCE(title, ''::text) || ' '::text) || COALESCE(content, ''::text))));


--
-- Name: notes trg_notes_updated_at; Type: TRIGGER; Schema: public; Owner: appuser
--
